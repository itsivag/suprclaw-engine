...
func TestResolveWorkspace(t *testing.T) {
	result := ResolveWorkspace("/home/user/.suprclaw")
	assert.Equal(t, "/home/user/.suprclaw/workspace", result)
}

func TestRelPath(t *testing.T) {
	result := RelPath("/home/user/.suprclaw/workspace/file.txt", "/home/user/.suprclaw")
...
func TestResolveTargetHome(t *testing.T) {
	...
	require.NoError(t, err)
	assert.Equal(t, filepath.Join(home, ".suprclaw"), result)
}
