...
func TestLoadOpenClawConfig(t *testing.T) {
	...
	if workspace != "~/.suprclaw/workspace" {
		t.Errorf("expected workspace '~/.suprclaw/workspace', got '%s'", workspace)
	}
...
func TestConvertToSuprClaw(t *testing.T) {
	tmpDir := t.TempDir()
	configPath := filepath.Join(tmpDir, "openclaw.json")
...
func TestConvertToSuprClawWithMatrix(t *testing.T) {
	tmpDir := t.TempDir()
	configPath := filepath.Join(tmpDir, "openclaw.json")
...
func TestConvertToSuprClawWithMatrixDisabled(t *testing.T) {
	tmpDir := t.TempDir()
	configPath := filepath.Join(tmpDir, "openclaw.json")
...
func TestToStandardConfig(t *testing.T) {
	...
	if stdCfg.Agents.Defaults.Workspace != "~/.suprclaw/workspace" {
		t.Errorf("expected workspace '~/.suprclaw/workspace', got '%s'", stdCfg.Agents.Defaults.Workspace)
	}
