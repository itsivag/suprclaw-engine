...
// DefaultConfig returns the default configuration for SuprClaw.
	...
	return &Config{
		...
		Tools: ToolsConfig{
			...
			BrowserRelay: BrowserRelayConfig{
				...
				AgentBrowserDefaultHeadless:         true,
				AgentBrowserMaxSessions:             8,
				AgentBrowserIdleTimeoutSec:          300,
				AgentBrowserBatchWindowMS:           25,
				AgentBrowserBatchMaxSteps:           24,
				AgentBrowserStreamEnabled:           true,
				AgentBrowserStreamPort:              0,
				AgentBrowserRuntimeCommandTimeoutMS: 30000,
				BootstrapIdentityHeader:             "",
				PairingCodeTTLSec:                   180,
				SessionTokenTTLSec:                  900,
				RefreshTokenTTLSec:                  604800,
				SnapshotDefaultMode:                 "compact",
				SnapshotMaxPayloadBytes:             98304,
				SnapshotMaxNodes:                    120,
				SnapshotMaxTextChars:                120,
				SnapshotMaxDepth:                    6,
				SnapshotInteractiveOnly:             true,
				SnapshotRefTTLSec:                   600,
				SnapshotMaxGenerations:              4,
