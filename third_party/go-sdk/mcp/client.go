...
func (c *Client) Connect(ctx context.Context, t Transport, opts *ClientSessionOptions) (cs *ClientSession, err error) {
	return c.ConnectWithSessionContext(ctx, ctx, t, opts)
}

// ConnectWithSessionContext begins an MCP session using separate contexts for
// bootstrap and long-lived connection ownership.
func (c *Client) ConnectWithSessionContext(
	bootstrapCtx context.Context,
	sessionCtx context.Context,
	t Transport,
	opts *ClientSessionOptions,
) (cs *ClientSession, err error) {
	cs, err = connectWithConnectionContext(bootstrapCtx, sessionCtx, t, c, (*clientSessionState)(nil), nil)
	if err != nil {
		return nil, err
	}
	...
	res, err := handleSend[*InitializeResult](bootstrapCtx, methodInitialize, req)
	if err != nil {
		_ = cs.Close()
		return nil, err
	}
	...
	if err := handleNotify(bootstrapCtx, notificationInitialized, req2); err != nil {
		_ = cs.Close()
		return nil, err
	}
