...
func connect[H handler, State any](ctx context.Context, t Transport, b binder[H, State], s State, onClose func()) (H, error) {
	return connectWithConnectionContext(ctx, ctx, t, b, s, onClose)
}

func connectWithConnectionContext[H handler, State any](
	...
	var zero H
	if bootstrapCtx == nil {
		panic("nil bootstrap context")
	}
	if connectionCtx == nil {
		panic("nil connection context")
	}
	mcpConn, err := t.Connect(bootstrapCtx)
	if err != nil {
		return zero, err
	}
	...
	_ = jsonrpc2.NewConnection(connectionCtx, jsonrpc2.ConnectionConfig{
		Reader:    reader,
		Writer:    writer,
		Closer:    mcpConn,
		Bind:      bind,
