...
Examples:
  suprclaw model                    # Show current default model
  suprclaw model gpt-5.2           # Set gpt-5.2 as default
  suprclaw model claude-sonnet-4.6 # Set claude-sonnet-4.6 as default
  suprclaw model local-model       # Set local VLLM server as default
