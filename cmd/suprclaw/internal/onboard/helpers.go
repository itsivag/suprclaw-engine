...
func onboard(encrypt bool) {
	...
	fmt.Println("\nNext steps:")
	if encrypt {
		fmt.Println("  1. Set your encryption passphrase before starting suprclaw:")
		fmt.Println("       export SUPRCLAW_KEY_PASSPHRASE=<your-passphrase>   # Linux/macOS")
		fmt.Println("       set SUPRCLAW_KEY_PASSPHRASE=<your-passphrase>      # Windows cmd")
		fmt.Println("")
	...
	fmt.Println("")
	fmt.Println("  3. Chat: suprclaw agent -m \"Hello!\"")
}
...
// setupSSHKey generates the suprclaw-specific SSH key at ~/.ssh/suprclaw_ed25519.key.
