...
CONTAINER_NAME="suprclaw-test-ergo"
IRC_PORT=6667
...
echo ""
echo "Add this to your ~/.suprclaw/config.json under \"channels\":"
echo ""
echo '  "irc": {'
echo '    "enabled": true,'
...
echo '  }'
echo ""
echo "Then run suprclaw:"
echo "  cd packages/suprclaw && go run ./cmd/suprclaw gateway"
echo ""
