...
# Refer to the MaixCAM GPIO documentation for pinmap commands
...
- Refer to the NanoKVM documentation for pin header details
...
- Download devmem from the board's package repository
